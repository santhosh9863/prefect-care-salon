    ...
    >
      <nav className="max-w-7xl mx-auto px-5 sm:px-8 h-16 sm:h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          <span
            className={`w-11 h-11 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-white text-sm sm:text-base font-bold tracking-wider transition-all duration-500 ${
              scrolled
                ? "bg-[#B91C1C] shadow-lg shadow-[#B91C1C]/30"
            ...
            <li key={link.label}>
              <Link
                ...
                className={`px-4 py-2 text-sm font-medium transition-all duration-300 relative rounded-full ${
                  scrolled
                    ? "text-gray-600 hover:text-[#B91C1C] hover:bg-[#B91C1C]/5"
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <a
            href="/book"
            className="px-6 py-2.5 bg-[#B91C1C] text-white text-sm font-semibold rounded-full hover:bg-[#991B1B] transition-all duration-300 hover:shadow-lg hover:shadow-red-900/30 hover:scale-105 sweep-effect"
          >
            Book Now
          </a>
        </div>
      ...
      >
        ...
        />
        <div
          className={`relative bg-white rounded-b-3xl shadow-2xl mx-4 mt-2 p-6 transition-all duration-500 ${
        ...
        >
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 flex flex-col gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 py-3 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
