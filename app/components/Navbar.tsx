...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <nav className="max-w-7xl mx-auto px-5 sm:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              href="/book"
              className="px-6 py-2.5 bg-[#B91C1C] text-white text-sm font-semibold rounded-full hover:bg-[#991B1B] transition-all duration-300 hover:shadow-lg hover:shadow-red-900/30 active:scale-95"
            >
              Book Now
            </a>
          </div>
      ...
      <div
        ref={menuRef}
        className={`lg:hidden fixed inset-0 z-[var(--z-menu-overlay)] transition-all duration-500 ${
      ...
      >
        ...
        />
        <div
          className={`absolute top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-2xl transition-all duration-500 ease-out ${
