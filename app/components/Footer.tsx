...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-400 pt-20 pb-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <span className="w-12 h-12 rounded-full bg-[#B91C1C] flex items-center justify-center text-white text-base font-bold">
                PC
              </span>
            ...
            <p className="text-sm leading-relaxed mb-6">
              Premium family salon in JP Nagar, Bangalore. Expert grooming services in a clean, modern environment.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>JP Nagar 7th Phase<br />Bangalore, Karnataka</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#B91C1C] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+919538111909" className="hover:text-white transition-colors">
                  +91 95381 11909
                </a>
              </li>
              <li className="flex items-center gap-3">
