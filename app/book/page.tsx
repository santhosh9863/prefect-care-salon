      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-4">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Your appointment request has been sent to WhatsApp. Please complete the booking there.
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-lg mx-auto px-4 py-10">
        <Link 
          href="/"
          className="inline-flex items-center gap-2 text-gray-600 hover:text-[#B91C1C] mb-8 transition-colors group"
        >
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-900/5 p-8">
          <div className="text-center mb-8">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#B91C1C]/10 flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-[#B91C1C] focus:ring-2 focus:ring-[#B91C1C]/20 outline-none transition-all"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-[#B91C1C] text-white py-4 rounded-xl font-semibold hover:bg-[#991B1B] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-[#B91C1C]/30 hover:shadow-xl hover:shadow-[#B91C1C]/40 active:scale-[0.98]"
            >
              {isSubmitting ? (
                <>
